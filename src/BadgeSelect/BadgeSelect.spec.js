...
describe('BadgeSelect', () => {
  ...
  it('should should pick the first option if no selectedId given', () => {
    const uncontrolledState = {selectedId: undefined};
    const {badgeDriver} = createComponent(uncontrolledState);
  ...
  describe('uncontrolled mode', () => {
    it('should change badge after an option is selected', () => {
      const uncontrolledState = {selectedId: undefined};
      const {driver, badgeDriver} = createComponent(uncontrolledState);
      const selectedIndex = 3;
